...
const BP = '/.paperclip/.playwright/chromium_headless_shell-1217/chrome-headless-shell-linux64/chrome-headless-shell';
...
(async () => {
  ...
  browser = await chromium.launch({ headless: true, executablePath: 'node_modules/playwright-core/.local-browsers/chromium_headless_shell-1223/chrome-headless-shell-linux64/chrome-headless-shell' });
